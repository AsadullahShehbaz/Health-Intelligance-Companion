            ...
            content=[
                {
                    ...
                    "text": (
                        ...
                        "Thoroughly analyze and transcribe all visible text, handwritten notes, "
                        "lab test results (with values, units, reference ranges), patient details, "
                        "and physician instructions from this image.\n"
                        "Maintain the structure and formatting as accurately as possible. "
                        "If text or handwriting is completely illegible, state '[unclear]'."
                    ),
                },
                {
                    "type": "image_url",
